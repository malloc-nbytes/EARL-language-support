...
" Language keywords
syntax keyword EARLKeywords break continue panic warn exit len println if if* else while for foreach import fn return assert print in let class pub world ref module constructor this true false none some match __internal_move__ fprintln fprint enum almost full int float tuple list bool to Char CSV IO SinglyLL List Math System Encryption Queue Set Stack Str Utils type typeof Dict continue const
